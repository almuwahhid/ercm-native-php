    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">Tambah Pengiriman Bahan</h2>
          <p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>
          <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php?page=daftarkirimbahan" class="breadcrumb-link">Pengiriman Bahan</a></li>
                <li class="breadcrumb-item active" aria-current="page">Tambah Pengiriman Bahan</li>
              </ol>
            </nav>
          </div>
        </div>
...
<?php
  ...
  if(isset($_POST['tanggal'])){
    ...
    if($hasil){
        echo "
        <script>
          window.alert('Berhasil menambahkan data Pengiriman Bahan');
